...
while True:
    ...
    if opcao in '1234567': # Se a opção for válida
      ...
      # cadastrar usuario
        if opcao == '1':
           ...
           cpf = validar_cpf("digite seu cpf: ")

           cadastrar_usuario(nome, cpf)
           
      # depositar 
        elif opcao == '2':
            cpf = validar_cpf("digite o CPF de destino do DEPÓSITO: ")
     ...
     #  transferência
            ...
            cpf_origem = validar_cpf("Dígite seu cpf: ")
            cpf_destino = validar_cpf("Dígite CPF  de destino da transfência: ")
            print("---VALOR DA TRANFERENCIA---")
    ...
    #  gerar extratos
               ...
               cpf = validar_cpf("Dite seu cpf: ")
               gerar_extrato(cpf)

    # Editar usuário (Grupo 3)         
        elif opcao == '6':
            cpf = validar_cpf("digite seu cpf: ")
            editar_usuario(cpf)
